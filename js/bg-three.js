...
(function () {
  ...
  const ITEMS = [
    { x: 0.02, y: 0.08, size: 0.80, opacity: 1,   lensWeight: 1,    grad: 0 },
    { x: 0.55, y: 0.30, size: 0.55, opacity: 0.6,  lensWeight: 0.8,  grad: 0 },
    { x: 0.22, y: 1.45, size: 0.94, opacity: 1,   lensWeight: 0.25, grad: 1 },
